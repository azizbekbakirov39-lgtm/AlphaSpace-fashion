...
const BottomNav: React.FC<BottomNavProps> = ({ activeTab, setActiveTab, language, user }) => {
  ...
  return (
    <div className="absolute bottom-0 left-0 right-0 z-[9999] bg-bg-primary/80 backdrop-blur-2xl border-t border-border-primary/50 px-2 pt-3 pb-[calc(1rem+env(safe-area-inset-bottom))] lg:hidden">
